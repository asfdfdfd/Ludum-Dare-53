...
{
    public class CorridorsOfLife01Segment : RhythmItemsSegment
    {
        ...
        private List<RhythmItemData> items = new List<RhythmItemData>()
        {
            ...
            new RhythmItemData(RhythmItemType.FOOD,          RhythmItemType.NOTHING,       RhythmItemType.NOTHING,      RhythmItemType.NOTHING),
            new RhythmItemData(RhythmItemType.NOTHING,       RhythmItemType.FOOD,       RhythmItemType.NOTHING,      RhythmItemType.NOTHING),
            new RhythmItemData(RhythmItemType.NOTHING,       RhythmItemType.NOTHING,          RhythmItemType.FOOD,      RhythmItemType.NOTHING),
            new RhythmItemData(RhythmItemType.NOTHING,          RhythmItemType.NOTHING,       RhythmItemType.NOTHING,      RhythmItemType.FOOD),
            new RhythmItemData(RhythmItemType.NOTHING,          RhythmItemType.NOTHING,       RhythmItemType.FOOD,      RhythmItemType.NOTHING),
            new RhythmItemData(RhythmItemType.NOTHING,          RhythmItemType.FOOD,       RhythmItemType.NOTHING,      RhythmItemType.NOTHING),
            new RhythmItemData(RhythmItemType.FOOD,          RhythmItemType.NOTHING,       RhythmItemType.NOTHING,      RhythmItemType.NOTHING),
            new RhythmItemData(RhythmItemType.NOTHING,       RhythmItemType.FOOD,       RhythmItemType.NOTHING,      RhythmItemType.NOTHING),
        ...
        public CorridorsOfLife01Segment(SpeedType speedType)
        {
